  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-fadeIn">
      <div className="relative w-full max-w-lg bg-white rounded-2xl shadow-2xl overflow-hidden border border-slate-100">
        ...
        {/* Channel Selector */}
        <div className="p-6">
          <div className="flex items-center space-x-2 p-1 bg-slate-100 rounded-xl mb-4 text-xs font-semibold">
            <button
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-xl p-3 mb-4 text-xs flex items-center justify-between">
            <div>
              <span className="text-slate-400 block text-[10px]">Recipient Phone / Email</span>
          ...
          <div className="mb-4">
            <div className="flex items-center justify-between mb-1.5">
              <label className="text-xs font-semibold text-slate-700">Pre-Filled Formatted Message</label>
              <button
                onClick={handleCopy}
            ...
            <textarea
              ...
              className="w-full p-3 text-xs bg-slate-50 border border-slate-200 rounded-xl font-mono text-slate-800 focus:bg-white focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none"
            />
          </div>
        ...
        <div className="bg-slate-50 px-6 py-4 border-t border-slate-100 flex items-center justify-between">
          <button
            onClick={onClose}
            className="px-4 py-2 border border-slate-200 rounded-xl text-slate-700 hover:bg-slate-100 text-xs font-semibold"
          >
            Cancel
          </button>
          <button
