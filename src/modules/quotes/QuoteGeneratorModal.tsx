      ...
      <div className="relative w-full max-w-3xl bg-white rounded-2xl shadow-2xl overflow-hidden border border-slate-100 my-auto">
        ...
        <div className="p-6 max-h-[75vh] overflow-y-auto space-y-6">
          ...
          <div className="bg-indigo-50/60 p-4 rounded-xl border border-indigo-200">
            <label className="block text-xs font-bold uppercase tracking-wider text-indigo-900 mb-1 flex items-center space-x-1.5">
            ...
            <div className="flex gap-2 mb-2">
              <input
                ...
                className="flex-1 px-3 py-2 text-xs bg-white border border-indigo-300 rounded-lg outline-none focus:ring-2 focus:ring-indigo-500 font-medium"
              />
              <button
                type="button"
            ...
            <div className="flex items-center space-x-1.5 overflow-x-auto pt-1">
              <span className="text-[10px] text-indigo-700 font-bold uppercase shrink-0">Sample Presets:</span>
              {samplePresets.map((preset, i) => (
                <button
                  key={i}
                  type="button"
                  onClick={() => handleApplyPreset(preset)}
                  className="px-2 py-1 rounded-md bg-white border border-indigo-200 hover:bg-indigo-100 text-indigo-800 text-[11px] font-medium whitespace-nowrap transition-colors"
                >
                  {preset.label}
                </button>
              ))}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <div>
              <label className="block text-[11px] font-semibold text-slate-700 mb-1">Estimated Timeline</label>
              <input
                type="text"
          ...
          <div>
            ...
            <div className="space-y-2">
              {items.map((item, index) => (
                <div
                  key={item.id || index}
                  className="flex items-center gap-2 p-3 bg-slate-50 border border-slate-200 rounded-xl text-xs"
                >
                  <input
                    type="text"
                    ...
                    className="flex-1 px-2.5 py-1.5 bg-white border border-slate-300 rounded-lg outline-none font-medium"
                  />
                  <input
                    type="number"
                    min="1"
                    ...
                    className="w-16 px-2 py-1.5 bg-white border border-slate-300 rounded-lg outline-none text-center font-mono"
                  />
                  <input
                    type="number"
                    min="0"
                    ...
                    className="w-24 px-2 py-1.5 bg-white border border-slate-300 rounded-lg outline-none text-right font-mono"
                  />
                  <div className="w-24 text-right font-bold font-mono text-slate-900">
            ...
            {/* Total */}
            <div className="flex justify-end pt-3 text-sm font-bold text-slate-900">
        ...
        {/* Footer Actions */}
        <div className="bg-slate-50 px-6 py-4 border-t border-slate-100 flex flex-wrap items-center justify-between gap-2">
          <button
            type="button"
            onClick={onClose}
